...
public class ClienIT {

    public static final String LOCALHOST = "http://localhost:";
    public static final String SERVICE_PATH = "/client";

    public static final Long NEW_CLIENT_ID = 6L;
    public static final String NEW_CLIENT_NAME = "Carlos";
    public static final String EXISTING_NAME = "Paula";
    ...
    @Test
    public void saveExistingNameShoudlInternalError() {
        ClientDto dto = new ClientDto();
